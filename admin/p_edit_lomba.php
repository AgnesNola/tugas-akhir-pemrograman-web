...
$status = $_POST['y_n'];
				try { $str_Query = "UPDATE perlombaan SET NAMA_PERLOMBAAN='$judul', KD_KATEGORI='$kategori', TANGGAL_PERLOMBAAN='$tgl_lomba', WAKTU_PERLOMBAAN='$time', DESKRIPSI_PERLOMBAAN='$deskripsi', status='$status' WHERE KD_PERLOMBAAN='$id'"; 
